...
class FCLayer(nn.Module):
    ...
    def backward(self, delta):
        ...
        """
        #TODO
        grad_W = self.X.T @ delta  # Gradient w.r.t. weights
        grad_b = delta.sum(dim=0, keepdim=True)  # Gradient w.r.t. biases
        delta_next = delta @ self.W.T  # Gradient to pass to the previous layer
...
class SigmoidLayer(nn.Module):
    ...
    def backward(self, delta):
        ...
        """
        delta_next = delta * self.Z * (1 - self.Z)  # Derivative of sigmoid
        return delta_next
...
class ReLULayer(nn.Module):
    ...
    def backward(self, delta):
        ...
        """
        #TODO
        delta_next = delta * (self.X > 0).float()  # Derivative of ReLU
        return delta_next
